...
session_start();
error_reporting(0);
$denominacion="iniciar sesion";
if( $_SESSION['usuario'] != null && $_SESSION['usuario']!=''){
	$varsesion = $_SESSION['usuario'];
//echo"<h1>BIENVENIDO: </h1>";
 //echo $_SESSION['usuario'];
 //$link_address1='cerrarsesion.php';
 $denominacion="cerrar sesion";
 //echo "<a href='".$link_address1."'>Cerrar Sesion</a>";
}
?>
				...
				<div class="row">
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								<?php
								if ($denominacion==="iniciar sesion"){
									$a="formulario.html";
									$clasea="fa fa-user";
									echo "<li><a href='".$a."'><i class='".$clasea."'></i>registrate</a></li>";
									$b="cart.html";
									$claseb="fa fa-shopping-cart";
									echo "<li><a href='".$b."'><i class='".$claseb."'></i>carrito</a></li>";
									$c="#";
									$clasec="fa fa-lock";
									echo "<li><a id=btn-abrir-popup  href='".$c."'><i class='".$clasec."'></i>iniciar sesion</a></li>";
									
									//AGREGANDO CODIGO DE POPUP
									echo <<<WXT
									<li>
								...
								WXT;
									...
									/////////////////////////////////como valor inicial es igual a iniciar sesion

								}else{
									$a="#";
									$clasea="fa fa-user";
									echo "<li><a href='".$a."'><i class='".$clasea."'></i>$varsesion</a></li>";
									$b="cart.html";
									$claseb="fa fa-shopping-cart";
									echo "<li><a href='".$b."'><i class='".$claseb."'></i>carrito</a></li>";
									...
									$c="cerrarsesion.php";
									$clasec="fa fa-lock";
									echo "<li><a href='".$c."'><i class='".$clasec."'></i>cerrar sesion</a></li>";			
